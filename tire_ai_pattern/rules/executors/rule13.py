...
from tire_ai_pattern.models.rule_models import BaseRuleFeature, BaseRuleScore, Rule13Config, Rule13Feature, Rule13Score
...
class Rule13Executor(RuleExecutor):
    ...
    def exec_feature(
        ...
        # tire_ai_pattern/nodes/stitch_scheme_generator.py::_instantiate_decoration_scheme
